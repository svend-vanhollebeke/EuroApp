...
urlpatterns = [
    ...
    path('stand_fruits', views.stand_fruits, name="stand_fruits"),
    path('stand_fleurs', views.stand_fleurs, name="stand_fleurs"),
    path('stand_legumes', views.stand_legumes, name="stand_legumes"),
